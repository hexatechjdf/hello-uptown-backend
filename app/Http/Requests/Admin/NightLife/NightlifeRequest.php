...
class NightlifeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price.discountPercentage' => 'nullable|numeric|min:0|max:100',
            'time' => 'nullable|array',
    ...
    public function messages(): array
    {
        return [
            ...
            'category_id.exists' => 'The selected category is invalid or not of type nightlife.',
            ...
            'price.discountPercentage.max' => 'Discount percentage cannot exceed 100%.',
        ];
    }
